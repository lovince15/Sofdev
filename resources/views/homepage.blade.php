...
<link href="{{url('public/plugins/font-awesome-4.7.0/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
...
<script src="{{url('public/styles/bootstrap-4.1.2/popper.js')}}"></script>
<script src="{{url('public/styles/bootstrap-4.1.2/bootstrap.min.js')}}"></script>
